...
.stApp {
    background: radial-gradient(circle at 10% 20%, #f4f7fb 0%, #e9f1f5 45%, #fdf7f0 100%);
    color: #1b1f24;
}

body, .stMarkdown, .stText, .stCaption, label, h1, h2, h3 {
    color: #1b1f24;
}
...
/* --- KODE TAMBAHAN UNTUK MEMPERBAIKI TEKS YANG HILANG --- */

/* Memaksa teks angka dan label metrik menjadi gelap */
...
/* Memaksa teks pada tab (Overview, Ablation, dll) menjadi gelap */
